...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-top:50px">
        <table style="background-color:lightgray; border-radius:10px; width:400px; margin-left:auto; margin-right:auto">
            <tr>
                <th colspan="3" style="padding:10px; background-color:black; border-top-left-radius:10px; border-top-right-radius:10px;">
            ...
            <tr>
                <td colspan="3" style="padding:10px; height: 62px;">
            ...
            <tr>
                ...
                <td style="padding:10px; text-align:center">
                    <asp:Button ID="Back" runat="server" Text="Back" OnClick="Button3_Click" style="background-color: #ffc100; border-color: #ffc100; border-width: 5px; color: #000000; width:120px; height:35px; border-radius:5px; font-size: 15px; font-weight: bolder " /><br />
                </td>
            </tr>
        </table>
    </div>
